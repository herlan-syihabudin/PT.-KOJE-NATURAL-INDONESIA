...
export const metadata = {
  title: 'Capabilities | KOJE Natural',
  description: 'PT KOJE Natural Indonesia operates as a procurement and manufacturing partner supporting industrial supply chains and distribution networks.',
}
