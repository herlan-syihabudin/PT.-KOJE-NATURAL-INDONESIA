...
const serviceAreas = [
  {
    ...
    description:
      'Supply of personal protective equipment and industrial safety products for workplace protection and operational requirements.',
  },
  {
    icon: HiOfficeBuilding,
    title: 'Fire Protection',
    description:
      'Supporting fire protection requirements through equipment sourcing, procurement coordination, and related safety supplies.',
  },
  {
    icon: HiClipboardCheck,
    title: 'Compliance Support',
    description:
      'Assistance with safety documentation, workplace requirements, supplier coordination, and implementation support.',
  },
]
...
const howWeSupport = [
  {
    title: 'PPE & Safety Equipment Sourcing',
    description:
      'We help identify and source personal protective equipment and industrial safety products based on workplace requirements, industry standards, and operational needs.',
  },
  {
    title: 'Fire Protection Solutions',
    description:
      'Supporting fire protection requirements through equipment identification, sourcing coordination, and related safety product procurement.',
  },
  {
    title: 'Compliance & Documentation Support',
    description:
      'We assist with safety documentation, workplace identification, supplier coordination, and implementation support according to client requirements.',
  },
  {
    title: 'Workplace Safety Implementation',
    description:
      'Safety requirements can be coordinated with operational needs, workplace conditions, regulatory standards, and project-specific safety protocols.',
  },
]
    ...
    <main id="top" className="pt-28 md:pt-32 pb-20 bg-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <span>/</span>
          <span className="text-gray-900">Safety & Compliance Solutions</span>
        </nav>
        ...
        {/* HOW WE SUPPORT SAFETY & COMPLIANCE */}
        <motion.section
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
