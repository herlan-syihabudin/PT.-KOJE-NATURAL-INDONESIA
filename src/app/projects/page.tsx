    ...
    <main className="bg-white text-gray-900">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="max-w-4xl">
            <div className="mb-6 inline-flex items-center gap-2 border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium uppercase tracking-[0.2em] text-gray-300">
              <HiClipboardCheck className="text-primary" />
              Projects & Operations
            </div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/contact"
                className="inline-flex min-h-[48px] items-center justify-center gap-2 bg-primary px-6 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-primary-dark"
              >
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            {projectCategories.map((category) => {
              ...
              return (
                <article
                  key={category.title}
                  className="group border border-gray-200 bg-white p-7 transition duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-xl md:p-8"
                >
                  <div className="flex items-start justify-between gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center bg-primary/10 text-2xl text-primary">
                      <Icon />
                    </div>
                  ...
                  <Link
                    href={category.href}
                    className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-gray-900 transition group-hover:text-primary"
                  >
                    Explore capability
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-14 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <Link
                href="/contact"
                className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-gray-900 hover:text-primary"
              >
                Start a discussion
                <HiArrowRight />
              </Link>
            ...
            <div className="divide-y divide-gray-200 border-y border-gray-200">
              {workflow.map((step) => (
                ...
                >
                  <div className="text-sm font-semibold tracking-[0.15em] text-primary">
                    {step.number}
                  </div>
      ...
      <section className="py-20 md:py-24">
        <div className="mx-auto max-w-5xl px-6">
          <div className="border border-gray-200 bg-gray-50 px-6 py-12 text-center md:px-12 md:py-16">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">
              Start a Project
            </p>
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Link
                href="/contact"
                className="inline-flex min-h-[48px] items-center justify-center gap-2 bg-primary px-7 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-primary-dark"
              >
                Request an RFQ
                <HiArrowRight />
              </Link>
